...
const TRADES: { code: string; name: string; docs: DocItem[] }[] = [
  ...
  { code: "260000", name: "Electric", docs: ["As-Built", { parent: "Testing/Demonstrations", children: ["PDU Start Up & Factory Reports", "UPS Start Up & Factory Reports", "Switch Gear Start Up Report"] }, "Equipment O&M", "Warranty"] },
  ...
  { code: "265000", name: "Lighting Fixtures", docs: [{ parent: "Testing/Demonstrations", children: ["Lighting Demonstrations"] }, "Equipment O&M", "Warranty"] },
